// Photography mosaic (home page). Builds the grid from the PHOTOS data; clicking
...
// toggle. pages/home.js calls initPhotoMosaic().
...
export function initPhotoMosaic() {
    ...
    if (mosaic) {
        PHOTOS.forEach(function (p, i) {
            ...
            // viewport (see features/media-loader.js).
