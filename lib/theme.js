...
//
//   dd: — the project's deep-dive page, every key optional, two kinds:
//     tones: {accent, ink, inkMid, inkSoft, line, surface} retint the page's
//     palette (ddVars() maps them to the --dd-* vars the .dd-page tone
//     channels prefer; dd.accent overrides the band accent for the page's
//     --pink channel).
//     element channels: {heroInk, eyebrowInk, labelInk, headingInk,
//     headingNum, noteAccent, copyInk} repaint one element kind directly
//     (the hero h1, the eyebrow kicker, the summary/note labels, the section
//     h2s, the 01/02 heading counters, the note's left bar, the body copy) —
//     they land as --dd-hero-ink etc., overriding the defaults assigned in
//     the .dd-page block (pages/deep-dive/deep-dive.css). Omitted keys keep
//     the cream light-on-dark palette; print re-pins every channel to
